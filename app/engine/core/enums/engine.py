...
class EngineEndpoint:
    ...
    def __init__(
        self, channel: Optional[str] = None, token: Optional[str] = None, **kwargs
    ) -> None:
...
class ErrorMessage:
    ...
    CHANNEL_NOT_PUBLIC = (
        "Channel is not public, you need to insert a valid token to access the channel"
    )
...
class EndpointDescription:
    ...
    def to_dict(self):
        return {
            "engine_endpoint_id": self.engine_endpoint_id,
...
class EndpointDescriptionField:
    ...
    def to_dict(self):
        return {
            "engine_endpoint_description_id": self.engine_endpoint_description_id,
            "field1_name": self.field1_name,
            "field2_name": self.field2_name,
            "field3_name": self.field3_name,
            "field4_name": self.field4_name,
            "field5_name": self.field5_name,
            "field6_name": self.field6_name,
            "field7_name": self.field7_name,
